...
/*let nams = [10,8,-7,55,987,-1011,0,1050,0];
...
console.log(sortNums(nams, 'ascending'));
console.log(sortNums(nams, 'descending'));*/
...
/*let filterArray = (array) => array.filter(value => value.monthDuration > 4);
